...
class Q1Env(mjx_env.MjxEnv):
  """Base class for Q1 environments."""
  ...
  def __init__(
    ...
    # Note: Q1 doesn't have floor contact sensors in the XML
    # We'll handle contact detection differently if needed
