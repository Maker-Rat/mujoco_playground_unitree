...
def brax_ppo_config(
  ...
  if env_name in ("Go1JoystickFlatTerrain", "Go1JoystickRoughTerrain", "Q1JoystickFlatTerrain", "Q1JoystickRoughTerrain", "SpiderbotJoystickFlatTerrain", "SpiderbotJoystickRoughTerrain",):
